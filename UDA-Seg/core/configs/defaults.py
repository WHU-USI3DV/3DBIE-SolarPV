...
_C.INPUT.SOURCE_PIXEL_MEAN = [0.485, 0.456, 0.406]
_C.INPUT.SOURCE_PIXEL_STD = [0.229, 0.224, 0.225]
_C.INPUT.TARGET_PIXEL_MEAN = [0.485, 0.456, 0.406]
_C.INPUT.TARGET_PIXEL_STD = [0.229, 0.224, 0.225]
_C.INPUT.TEST_PIXEL_MEAN = [0.485, 0.456, 0.406]
_C.INPUT.TEST_PIXEL_STD = [0.229, 0.224, 0.225]
